...
def main():
    ...
    try:
        ...
        print("="*80)
        print(f"\n? Best Score: {results['best_value']:.4f}")
        print(f"Best Return: {results['best_metrics'].get('return', 'N/A')}")
        print(f"Best Sharpe: {results['best_metrics'].get('sharpe', 'N/A')}")
        print(f"Max DD: {results['best_metrics'].get('max_dd', 'N/A')}")
        print(f"Trades: {results['best_metrics'].get('trades', 'N/A')}")
        print(f"Win Rate: {results['best_metrics'].get('win_rate', 'N/A')}")
        print()
